...
<body>
    ...
    <div id="heroCarousel" class="container carousel carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
      ...
      <div class="carousel-item active">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown">Wonderful <span>Yogyakarta</span></h2>
          <p class="animate__animated animate__fadeInUp">Website yang akan membantu anda dalam menemukan tempat wisata terbaik di Yoyakarta</p>
      ...
      <div class="container">
        <div class="section-title">
          <div class="row" data-aos="fade-up">
            <h2>Kabupaten/Kota Provinsi Yogyakarta</h2>
          </div>
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Kelompok Proyek Pengembangan Sistem Informasi</span></strong>
      </div>
      <div class="credits">
        Created by Anik & Yesi</a>
      </div>
    </div>
  </footer><!-- End Footer -->
